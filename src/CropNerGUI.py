...
class CropNerGUI:
    ...
    def toggle_metadata(self):
        ...
        def save():
            ...
            self.crop = crop_entry.get().upper()
            self.cvar = cvar_entry.get().upper()
    ...
    def file_save(self):
        ...
        if self.cust_ents_dict:
            ...
            ann_train_dict = mixed_type_2_dict(input_text, entities, self.chunk, doc=self.doc,
