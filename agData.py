...
TRAIN_DATA = [
    ...
    ('It has rough awns, midseason maturity, good winter hardiness, and is medium height with intermediate lodging resistance', {'entities': [(13, 17,'PLAN'), (19, 37, 'TRAT'), (44, 60, 'TRAT'), (76, 82, 'TRAT'), (101,119, 'TRAT')]}),
    ...
    ('Maja, like the 88Ab536 parent, is a facultative cultivar: ithas a \"winter\"allele at the Vm-H1 locus on chromosome 5H but lacks the repressor encoded by the Vrn-H2 locus on 4H.', {'entities': [(0, 4, 'CVAR'), (15, 22,'CVAR'), (36, 47, 'TRAT')]}),
    ('It is a standard height selection (averages about 42 inches in plant height, with fair straw strength) with rough awns and a semi-compact spike', {'entities': [(17, 23, 'TRAT'), (63, 75, 'TRAT'), (87, 101,'TRAT'), (108, 118, 'TRAT'), (138, 143, 'PLAN')]}),
    ('The grain has white aleurone', {'entities': [(4, 9, 'PLAN'), (20, 28, 'PLAN')]}),
    ('Maja has high test weight and showed promise as malting barley in repeated micro-malting tests', {'entities': [(0, 4, 'CVAR'), (14, 25, 'TRAT'), (48, 62, 'TRAT')]}),
    ...
    ('It is a doubled-haploid line produced fromthe cross I1162-19/J-126//WA1245///Steptoe', {'entities': [(52, 85, 'PED')]}),
    ('Its experimental designation was ORW-6', {'entities': [(33, 38, 'ALAS')]}),
    ('It is medium height (averages about 41 inches, slightly taller than Kold) and medium early maturing with fair straw strength', {'entities': [(13,19, 'TRAT'), (68, 72, 'CVAR'), (91, 99, 'TRAT'), (110, 124, 'TRAT')]}),
